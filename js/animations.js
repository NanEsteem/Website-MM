document.addEventListener('DOMContentLoaded',function(event){
    ...
    var dataText = [ "beginnings can be hard", "be persistent", "believe in yourself"];
    ...
    function typeWriter(text, i, fnCallback) {
      ...
      if (i < (text.length)) {
       ...
       document.querySelector("p.name").innerHTML = text.substring(0, i+1) +'<span aria-hidden="true"></span>';
